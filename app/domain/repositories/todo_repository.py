...
class TodoRepository(ABC):
    ...
    @abstractmethod
    def find_by_status(self, status: TodoStatus, user_id: int | None = None) -> list[Todo]:
    ...
    @abstractmethod
    def find_by_priority(self, priority: TodoPriority, user_id: int | None = None) -> list[Todo]:
